...
const Skills = () => {
  return (
    <section id='skills'>
      ...
      <span className='skillDesc'>Kami adalah platform jasa pembuatan website yang telah terpercaya dan terbukti memberikan transaksi yang aman dengan transparansi dan integritas tinggi. Setiap situs web yang terdaftar melalui platform kami mengikuti proses verifikasi yang ketat untuk memastikan legalitas dan keaslian properti digital yang dijual.</span>        
